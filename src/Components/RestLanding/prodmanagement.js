...
function ProdManagement(){
    return(
        <div>
            ...
            <div class="restdashboard-item2" style={{marginLeft:'10vw'}}>
                <h3>Restaurant Management System</h3>
                </div>
            <div class="restdashboard-item4" style={{marginTop:'-2vh'}}>
            <div class="container bcontent" style={{marginLeft:'10vw'}}>
                {
                    PItems.items.map(
                        item=>(
        <div class="card" style={{width: "60vw",marginBottom:"10vh"}}>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <p class="card-text" style={{fontSize:'15px'}}>{item.description}</p>
                        <a href="#" class="btn btn-primary">Available</a>
                        <a href="#" class="btn btn-danger" style={{marginLeft:'5vw'}}>Unavailable</a>
                        <Link to='/produpdate' class="btn btn-success" style={{marginLeft:'5vw'}}>Update</Link>
                    </div>
                </div>
